...
from Budget.views import (area, calculadora, empresas, feedback,
...
urlpatterns = [
    ...
    path('simulador', views.simulador, name='simulador'),  # Sobre Nós
    path('resultados', views.resultados, name='resultados'),  # Sobre Nós
